...
// ✅ Fix #3: Register ScrollTrigger plugin
...
const ProjectCard = ({ project }: { project: Project }) => {
  ...
  // ✅ Fix: clicking anywhere on the card toggles audio
  const handleCardClick = () => {
    const next = !isAudioEnabled;
    setIsAudioEnabled(next);
    if (videoRef.current) {
      videoRef.current.muted = !next;
      if (next && videoRef.current.paused && isHovered) {
        videoRef.current.play().catch(() => {});
      }
    }
  };
  ...
  return (
    <div
      ...
      className="group relative flex flex-col bg-surface/30 border border-white/5 hover:border-neon-pink/30 transition-all duration-500 overflow-hidden cursor-pointer"
    >
      {/* Full video — no height constraint at all, video shows 100% uncropped */}
      <div className="relative w-full bg-black">
        <video
          ...
          // ✅ object-contain = full video shown, no cropping, black bars on sides if needed
        ...
        {/* Click anywhere hint — shows on hover when muted */}
        ...
        {/* Sound icon — always visible on hover so user knows state */}
        <div className="absolute top-2 right-2 z-30 p-1.5 bg-black/60 backdrop-blur-md rounded-full border border-white/10 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
          {isAudioEnabled ? <Volume2 size={12} className="text-neon-pink" /> : <VolumeX size={12} className="text-white" />}
        </div>
  ...
  const projects: Project[] = [
    {
      ...
      videoUrl:
        "https://res.cloudinary.com/dv5ic5hc0/video/upload/f_auto,q_auto:eco,w_480/v1780216311/WhatsApp_Video_2026-05-30_at_2.17.07_PM_rbtnls.mp4",
      thumbnail:
        "https://res.cloudinary.com/dv5ic5hc0/video/upload/so_auto,f_jpg,w_480/v1780216311/WhatsApp_Video_2026-05-30_at_2.17.07_PM_rbtnls.jpg",
    },
    {
      ...
      videoUrl:
        "https://res.cloudinary.com/dv5ic5hc0/video/upload/f_auto,q_auto:eco,w_480/v1780217086/WhatsApp_Video_2026-05-30_at_2.17.06_PM_ihtcfg.mp4",
      thumbnail:
        "https://res.cloudinary.com/dv5ic5hc0/video/upload/so_auto,f_jpg,w_480/v1780217086/WhatsApp_Video_2026-05-30_at_2.17.06_PM_ihtcfg.jpg",
    },
    {
      ...
      videoUrl:
        "https://res.cloudinary.com/dv5ic5hc0/video/upload/f_auto,q_auto:eco,w_480/v1780217415/WhatsApp_Video_2026-05-30_at_2.17.05_PM_g8ojxl.mp4",
      thumbnail:
        "https://res.cloudinary.com/dv5ic5hc0/video/upload/so_auto,f_jpg,w_480/v1780217415/WhatsApp_Video_2026-05-30_at_2.17.05_PM_g8ojxl.jpg",
    },
  ];
